...
public class GraphSelectionEvent extends EventObject
{
     ...
     * @param areNew for each cell, defines whether or not that cell is newly
     *               selected
     */
     ...
     *
     * @param cell the cell that is to be indicated as newly selected or not
     ...
     *
     * @param index the index of <code>areNew</code> of the cell that is to be
