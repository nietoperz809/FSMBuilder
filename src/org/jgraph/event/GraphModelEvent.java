...
public class GraphModelEvent extends EventObject
{
     ...
     *
     * @param source the Object responsible for generating the event (typically the
    ...
    public static interface GraphModelChange extends GraphLayoutCacheEvent.GraphLayoutCacheChange
    {
         ...
         *
         * @param view      the <code>GraphLayoutCache</code> to store the removed
         *                  cells
         * @param cellViews the cell views to be stored
         */
         ...
         *
         * @param view the <code>GraphLayoutCache</code> whose stored cells are
         *             to be retrieved
         */
