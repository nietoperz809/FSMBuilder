...
public class PortView extends AbstractCellView
{
    ...
    public Rectangle2D getBounds()
    {
        ...
        bounds.setFrame(bounds.getX() - getPortSize() / 2, bounds.getY() - getPortSize() / 2, getPortSize(), getPortSize());
        return bounds;
    }
    ...
    {
        return allowPortMagic && !(getParentView() instanceof EdgeView) && edge.getPointCount() > 2 && GraphConstants.getLineStyle(edge.getAllAttributes()) == GraphConstants.STYLE_ORTHOGONAL;
    }
