...
public class GraphLayoutCache implements CellMapper, Serializable
{
            ...
            for (int i = 0; i < changed.length; i++)
            {
                ...
                if (view instanceof EdgeView)
                {
                    ...
                    if ((hidesDanglingConnections && (removed
                            .contains(oldSource) || removed.contains(oldTarget))) || hideExisting)
                    {
     ...
     *
     * @param cell    the cell whose visibility is to be changed
     * @param visible <code>true</code> if cell is to be made visible
     */
     ...
     *
     * @param cells   the cells whose visibility is to be changed
     * @param visible <code>true</code> if the cells are to be made visible
     */
     ...
     *
     * @param visible   cells to be made visible
     * @param invisible cells to be made invisible
     */
     ...
     * @param visible   cells to be made visible
     * @param invisible cells to be made invisible
     * @param cs        a <code>ConnectionSet</code> describing the new state of
     ...
     * </pre>
     *
     * @param cell inserts the specified cell in the cache
     */
     ...
     * @param source the source port this edge is connected to
     * @param target the target port this edge is connected to
     */
     ...
     * @param descendants Whether to remove all descendants as well.
     * @param edges       Whether to remove all connected edges as well.
     */
     ...
     *
     * @param cells        The cells to toggle the collapsed state for.
     * @param collapseOnly Whether cells should only be collapsed.
     * @param expandOnly   Whether cells should only be expanded.
     */
     ...
     *
     * @param collapse the cells to be collapsed
     * @param expand   the cells to be expanded
     */
     ...
     *
     * @param key        the key of the view local attribute
     * @param addToModel whether or not to move the attribute values to the graph model
     * @param override   whether or not to override the key's value in the model cell's
    ...
    public class GraphLayoutCacheEdit extends CompoundEdit implements GraphLayoutCacheEvent.GraphLayoutCacheChange
    {
         ...
         *
         * @param nested the map that defines the new attributes
         */
         ...
         *
         * @param inserted   an array of inserted cells
         * @param attributes the map that defines the new attributes
         * @param visible    an array defining which cells are visible
         * @param invisible  an array defining which cells are invisible
         */
     ...
     *
     * @param views an array of cell view to each be translated
     * @param dx    the amount to translate the views in the x-axis
     * @param dy    the amount to translate the views in the x-axis
     */
     ...
     *
     * @param cell         The cell from which the neighbours will be determined
     * @param exclude      The set of cells to ignore when searching
     * @param directed     whether or not direction of edges should be taken into account
     * @param visibleCells whether or not to only consider visible cells
     ...
     *
     * @param cell         The cell from which the outgoing edges will be determined
     * @param exclude      The set of edges to ignore when searching
     * @param visibleCells whether or not only visible cells should be processed
     * @param selfLoops    whether or not to include self loops in the returned list
     ...
     *
     * @param cell         The cell from which the incoming edges will be determined
     * @param exclude      The set of edges to ignore when searching
     * @param visibleCells whether or not only visible cells should be processed
     * @param selfLoops    whether or not to include self loops in the returned list
     ...
     * a vertex.
     *
     * @param cell         The cell from which the edges will be determined
     * @param exclude      The set of edges to ignore when searching
     * @param visibleCells whether or not only visible cells should be processed
     * @param selfLoops    whether or not to include self loops in the returned list
     * @param incoming     <code>true</code> if incoming edges are to be obtained,
    ...
    protected List getEdges(Object cell, Set exclude, boolean visibleCells, boolean selfLoops, boolean incoming)
    {
        ...
        for (int i = 0; i < edges.length; i++)
        {
            ...
            if ((exclude == null || !exclude.contains(edges[i])) && !localExclude.contains(edges[i]) && (!visibleCells || isVisible(edges[i])))
            {
                ...
                if (selfLoops == true || model.getSource(edges[i]) != model
                        .getTarget(edges[i]))
                {
    ...
    /**
     * @param localAttributes The localAttributes to set.
     */
    ...
    /**
     * @param allAttributesLocal The allAttributesLocal to set.
     */
     ...
     * existing setting.
     *
     * @param flag a boolean value, true if cells should be auto-sized when their
     *             values change
     */
    ...
    /**
     * @param selectsAllInsertedCells The selectsAllInsertedCells to set.
     */
    ...
    /**
     * @param selectsLocalInsertedCells The selectsLocalInsertedCells to set.
     */
    ...
    /**
     * @param reconnectsEdgesToVisibleParent The reconnectsEdgesToVisibleParent to set.
     * @deprecated edges are moved to parent view and back automatically
     */
    ...
    /**
     * @param showsChangedConnections The showsChangedConnections to set.
     */
    ...
    /**
     * @param moveChildrenOnExpand The moveChildrenOnExpand to set.
     */
    ...
    /**
     * @param collapseXScale The collapseXScale to set.
     */
    ...
    /**
     * @param collapseYScale The collapseYScale to set.
     */
	...
	/**
     * @param movesParentsOnCollapse The movesParentsOnCollapse to set.
     */
	...
	/**
     * @param resizesParentsOnCollapse The resizesParentsOnCollapse to set.
     */
