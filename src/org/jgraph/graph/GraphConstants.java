...
public class GraphConstants
{
    ...
    static public Stroke SELECTION_STROKE = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, dash, 0.0f);
     ...
     *
     * @param map  The map to store the link attribute in.
     * @param link The value to set the link attribute to.
     */
