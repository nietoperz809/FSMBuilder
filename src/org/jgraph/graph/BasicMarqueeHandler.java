...
public class BasicMarqueeHandler
{
    ...
    public void mouseReleased(MouseEvent e)
    {
        try
        {
            if (e != null && marqueeBounds != null)
            {
                ...
                Rectangle dirty = new Rectangle((int) marqueeBounds.getX(), (int) marqueeBounds.getY(), (int) marqueeBounds
    ...
    public void overlay(JGraph graph, Graphics g, boolean clear)
    {
        if (marqueeBounds != null)
        {
            ...
            g.drawRect((int) marqueeBounds.getX(), (int) marqueeBounds.getY(), (int) marqueeBounds.getWidth(), (int) marqueeBounds
                    .getHeight());
        }
    }
