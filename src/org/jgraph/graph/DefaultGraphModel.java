...
//	private transient boolean isDispatching = false;
    ...
    {
        if ((inserted == null || inserted.length == 0) && (removed == null || removed.length == 0) && (attributes == null || attributes.isEmpty()) && (cs == null || cs.isEmpty()) && pm == null && edits != null && edits.length == 1)
        {
...
//		}
    ...
    public class GraphModelEdit extends CompoundEdit implements GraphModelEvent.GraphModelChange
    {
         ...
         * @param attributes    the attribute changes made by the edit
         * @param connectionSet the set of changed connections
         * @param parentMap     the map of changed parents
         */
...
//			dirtyRegion = null;
     ...
     *
     * @param cell the cell to check for being a group
